...
backend = "http://localhost:8000/segmentation"
#  streamlit run fastapi_example/ui.py
...
if st.button("Get segmentation map"):
    ...
    if input_image:
        ...
        col1.image(original_image, use_column_width=False)
        col2.header("Segmented")
        col2.image(segmented_image, use_column_width=False)
